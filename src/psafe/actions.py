...
ACTION_REQUIRES_BM25: Dict[Action, bool] = {a: a in {
...
ACTION_AVAILABILITY: Dict[Action, str] = {
    Action.A0_DENSE: "always",
    Action.A1_DENSE_BM25: "requires_bm25",
    Action.A2_DENSE_GRAPH: "requires_graph",
    Action.A3_DENSE_BM25_GRAPH: "requires_bm25_graph",
    Action.A4_DENSE_BM25_CE: "requires_bm25_reranker",
    Action.A5_DENSE_BM25_GRAPH_CE: "requires_bm25_graph_reranker",
    Action.A6_DEEP_HYBRID: "requires_bm25_graph_reranker",
    Action.A7_DENSE_BM25_CE_10: "requires_bm25_reranker",
    Action.A8_DENSE_BM25_CE_20: "requires_bm25_reranker",
    Action.A9_DENSE_BM25_CE_50: "requires_bm25_reranker",
    Action.A10_DENSE_BM25_CE_100: "requires_bm25_reranker",
    Action.A11_DYNAMIC_CE_DEPTH: "requires_bm25_reranker",
    Action.A12_BGEM3_DENSE: "requires_bgem3",
    Action.A13_BGEM3_SPARSE: "requires_bgem3",
    Action.A14_BGEM3_DENSE_SPARSE: "requires_bgem3",
    Action.A15_BGEM3_DENSE_SPARSE_MULTI: "requires_bgem3",
    Action.A16_BGEM3_DENSE_SPARSE_CE: "requires_bgem3_reranker",
}
