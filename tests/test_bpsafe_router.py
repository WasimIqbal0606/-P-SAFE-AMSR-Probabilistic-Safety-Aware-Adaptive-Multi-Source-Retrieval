...
def test_dense_fallback_is_a0():
    ...
    from psafe.routers.bpsafe_router import BPSafeRouter, PSafeDecision
    from psafe.retrievers.actions import Action
...
def test_prior_probability_model_deterministic():
    ...
    from psafe.routers.bpsafe_router import PriorProbabilityModel
